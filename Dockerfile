...
ARG MATOMO_SITE_ID MATOMO_URL TARGET_ENV ONION_ADDRESS DRONE_COMMIT_SHA DRONE_BUILD_NUMBER DRONE_BUILD_LINK DRONE_COMMIT_LINK DRONE_REPO_LINK DRONE_BUILD_FINISHED
ENV MATOMO_SITE_ID=$MATOMO_SITE_ID MATOMO_URL=$MATOMO_URL TARGET_ENV=$TARGET_ENV ONION_ADDRESS=$ONION_ADDRESS
